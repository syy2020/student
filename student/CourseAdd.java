...
class CourseAdd extends JFrame implements ActionListener{
	...
	JTextField t学号 = new JTextField(10);
	JTextField t姓名 = new JTextField(10);
	JTextField t填报时间 = new JTextField(10);
	JTextField t所在地 = new JTextField(10);
	//JComboBox<String> cb所在地 = new JComboBox<String>();
	JTextField t当前健康状况 = new JTextField(10);
	...
	public void insert() { // 插入记录
		...
		try{
			...
			JOptionPane.showMessageDialog(null, "学分必须是整数！");
			t当前健康状况.setText("");
		}
		closeDB();
	}
